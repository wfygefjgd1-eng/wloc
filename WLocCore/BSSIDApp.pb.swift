...
struct App_WifiDevice {
    var bssid: String = ""
    var location: App_Location? = nil
...
struct App_AppWLoc {
    var wifiDevices: [App_WifiDevice] = []
    var numCellResults: Int32? = nil
    var numWifiResults: Int32? = nil
    var appBundleID: String? = nil
    var cellTowerResponse: [App_CellTower] = []
    var cellTowerRequest: App_CellTower? = nil
    var deviceType: App_DeviceType? = nil
    var unknownFields = UnknownStorage()

    init() {}
}

struct App_CellTower {
    var mcc: UInt32 = 0
    var mnc: UInt32 = 0
    var cellID: UInt32 = 0
    var tacID: UInt32 = 0
...
extension App_WifiDevice: Message, _MessageImplementationBase, _ProtoNameProviding {
    ...
    static func == (lhs: App_WifiDevice, rhs: App_WifiDevice) -> Bool {
        lhs.bssid == rhs.bssid &&
...
extension App_AppWLoc: Message, _MessageImplementationBase, _ProtoNameProviding {
    ...
    static func == (lhs: App_AppWLoc, rhs: App_AppWLoc) -> Bool {
...
extension App_CellTower: Message, _MessageImplementationBase, _ProtoNameProviding {
    ...
    static func == (lhs: App_CellTower, rhs: App_CellTower) -> Bool {
        lhs.mcc == rhs.mcc &&
        lhs.mnc == rhs.mnc &&
...
extension App_DeviceType: Message, _MessageImplementationBase, _ProtoNameProviding {
    ...
    static func == (lhs: App_DeviceType, rhs: App_DeviceType) -> Bool {
...
extension App_Location: Message, _MessageImplementationBase, _ProtoNameProviding {
    ...
    static func == (lhs: App_Location, rhs: App_Location) -> Bool {
